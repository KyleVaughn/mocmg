...
#    R_i = [R0_i, R1_i, R2_i, R3_i]    
    ...
    R_IFBA_i = mocmg.findLinearRingRadius_flatField(R_fuel_i, np.pi*(R2_i**2 - R3_i**2), lcmin) 
    ...
    coords_IFBA = [
            (1, 17), (17, 17),
            (6, 16), (9, 16), (12, 16),
            (3, 15), (5, 15), (8, 15), (10, 15), (13, 15), (15, 15),
            (5, 14), (6, 14), (12, 14), (13, 14),
            (3, 13), (4, 13), (6, 13), (9, 13), (12, 13), (14, 13), (15, 13),
            (2, 12), (4, 12), (5, 12), (8, 12), (10, 12), (13, 12), (14, 12), (16, 12),
            (7, 11), (11, 11),
            (3, 10), (6, 10), (9, 10), (12, 10), (15, 10),
            (2, 9), (5, 9), (8, 9), (10, 9), (13, 9), (16, 9),
            (3, 8), (6, 8), (9, 8), (12, 8), (15, 8),
            (7, 7), (11, 7),
            (2, 6), (4, 6), (5, 6), (8, 6), (10, 6), (13, 6), (14, 6), (16, 6),
            (3, 5), (4, 5), (6, 5), (9, 5), (12, 5), (14, 5), (15, 5),
            (5, 4), (6, 4), (12, 4), (13, 4),
            (3, 3), (5, 3), (8, 3), (10, 3), (13, 3), (15, 3),
            (6, 2), (9, 2), (12, 2),
            (1, 1), (17, 1),
            ]
    coords_f = []
...
#    gmsh.model.mesh.setSize(gmsh.model.getEntities(0), lc)
    ...
    IFBAEnts = mocmg.getEntitiesForPhysicalGroupName(f"MATERIAL_IFBA")
    IFBAEnts_dimTags = [(2, t) for t in IFBAEnts]
    IFBABounds_dimTags = gmsh.model.getBoundary(
        IFBAEnts_dimTags, combined=False, oriented=False
    )
...
#    gmsh.fltk.run()
    ...
    gap_area = (17*17-25-80)*np.pi*(R1_f**2 - R2_f**2) + 80*np.pi*(R1_i**2 - R2_i**2)
