...
class test_abaqusIO(TestCase):
    def test_triangleOnlyINP(self):
        ...
        out_ref = [
            "INFO      : mocmg.abaqusIO - Reading mesh data from tests/abaqus/triangle_only.inp"
        ]
        err_ref = []
    ...
    def test_mixedTopology2ndOrderINP(self):
        ...
        out_ref = [
            "INFO      : mocmg.abaqusIO - Reading mesh data from tests/abaqus/mixed_topology.inp"
        ]
        err_ref = []
        # Caputure output since bb will throw warning on purpose
        with captured_output() as (out, err):
    ...
    def test_cell_sets(self):
        ...
        out_ref = [
            "INFO      : mocmg.abaqusIO - Reading mesh data from tests/abaqus/disks_mixed.inp"
        ]
        err_ref = []
        # Caputure output since bb will throw warning on purpose
        with captured_output() as (out, err):
